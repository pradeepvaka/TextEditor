...
public class EfficientDocument extends Document {
	...
	private void processText()
	{
		...
		if(tokens.size()==0) return; //return count of 0 if empty string
		Boolean lastseen = true; //remember if last seen token is word or punctuation
